...
<table width="100%"  class="table_form">
 <tr>
   ...
   <td class="y-bg"><input type="text" class="input-text" name="my_tel" id="my_tel" size="30" value="<?php echo $data['my_tel']?>" /></td>
 </tr>
 <tr>
   <th><?php echo L('my_mobile')?>：</th>
   <td class="y-bg"><input type="text" class="input-text" name="my_mobile" id="my_mobile" size="30" value="<?php echo $data['my_mobile']?>" /></td>
 </tr>
 <tr>
   <th><?php echo L('my_fax')?>：</th>
   <td class="y-bg"><input type="text" class="input-text" name="my_fax" id="my_fax" size="30" value="<?php echo $data['my_fax']?>" /></td>
 </tr>
 <tr>
   <th><?php echo L('my_address')?>：</th>
   <td class="y-bg"><input type="text" class="input-text" name="my_address" id="my_address" size="30" value="<?php echo $data['my_address']?>" /></td>
 </tr>
 <tr>
   <th><?php echo L('my_sina')?>：</th>
   <td class="y-bg"><input type="text" class="input-text" name="my_sina" id="my_sina" size="30" value="<?php echo $data['my_sina']?>" /></td>
 </tr>
 <tr>
   <th><?php echo L('my_tqq')?>：</th>
   <td class="y-bg"><input type="text" class="input-text" name="my_tqq" id="my_tqq" size="30" value="<?php echo $data['my_tqq']?>" /></td>
 </tr>
<tr>
   <th><?php echo L('my_qq01')?>：</th>
   <td class="y-bg"><input type="text" class="input-text" name="my_qq01" id="my_qq01" size="30" value="<?php echo $data['my_qq01']?>" /></td>
 </tr>
<tr>
   <th><?php echo L('my_qq02')?>：</th>
   <td class="y-bg"><input type="text" class="input-text" name="my_qq02" id="my_qq02" size="30" value="<?php echo $data['my_qq02']?>" /></td>
 </tr>
<tr>
   <th><?php echo L('my_qq03')?>：</th>
   <td class="y-bg"><input type="text" class="input-text" name="my_qq03" id="my_qq03" size="30" value="<?php echo $data['my_qq03']?>" /></td>
 </tr>
<tr>
   <th><?php echo L('my_email')?>：</th>
   <td class="y-bg"><input type="text" class="input-text" name="my_email" id="my_email" size="30" value="<?php echo $data['my_email']?>" /></td>
 </tr>
<tr>
   <th><?php echo L('my_icp')?>：</th>
   <td class="y-bg"><input type="text" class="input-text" name="my_icp" id="my_icp" size="30" value="<?php echo $data['my_icp']?>" /></td>
 </tr>
</table>
</fieldset>
<div class="bk10"></div>

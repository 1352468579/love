...
<?php $n=1;if(is_array($data)) foreach($data AS $r) { ?>
<li class="list_picture-<?php echo $n;?>"><a href="<?php echo $r['url'];?>" title="<?php echo $r['title'];?>"><img src="<?php if($r[thumb]) { ?><?php echo $r['thumb'];?><?php } else { ?><?php echo siteurl($siteid);?>/statics/fst/images/nopic.jpg<?php } ?>" alt="<?php echo $r['title'];?>"/><?php echo $r['title'];?></a></li>
<?php $n++;}unset($n); ?>
<?php if(defined('IN_ADMIN') && !defined('HTML')) {echo '</div>';}?>
      </ul>

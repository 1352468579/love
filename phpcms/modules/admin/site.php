...
//在'default_style'=>$default_style之后新增如下：
			if ($this->db->insert(array('name'=>$name,'dirname'=>$dirname, 'domain'=>$domain, 'site_title'=>$site_title, 'keywords'=>$keywords, 'description'=>$description, 'release_point'=>$release_point, 'template'=>$template,'setting'=>$setting, 'default_style'=>$default_style, 'my_tel'=>$my_tel,'my_mobile'=>$my_mobile,'my_fax'=>$my_fax,'my_address'=>$my_address,'my_sina'=>$my_sina,'my_tqq'=>$my_tqq,'my_qq01'=>$my_qq01,'my_qq02'=>$my_qq02,'my_qq03'=>$my_qq03,'my_email'=>$my_email,'my_icp'=>$my_icp))) {
